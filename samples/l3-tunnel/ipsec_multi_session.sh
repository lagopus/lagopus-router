...
set interfaces interface tif0 subinterfaces subinterface 0 tunnel config remote-inet-address 10.10.0.3
...
set network-instances network-instance vrf1 security ipsec sad sad-entries 2 config esp authentication hmac-sha1-96 key-str 00112233445566778899aabbccddeeff00112233
set network-instances network-instance vrf1 security ipsec sad sad-entries 2 config esp encryption aes-128-cbc key-str 00112233445566778899aabbccddeeff
...
set network-instances network-instance vrf1 security ipsec sad sad-entries 3 config esp authentication hmac-sha1-96 key-str 00112233445566778899aabbccddeeff00112232
set network-instances network-instance vrf1 security ipsec sad sad-entries 3 config esp encryption aes-128-cbc key-str 00112233445566778899aabbccddeefe
set network-instances network-instance vrf1 security ipsec sad sad-entries 4 config sa-mode tunnel
set network-instances network-instance vrf1 security ipsec sad sad-entries 4 config life-time life-time-in-seconds 0
set network-instances network-instance vrf1 security ipsec sad sad-entries 4 config life-time life-time-in-byte 0
set network-instances network-instance vrf1 security ipsec sad sad-entries 4 config local-peer ipv4-address 10.10.0.1
set network-instances network-instance vrf1 security ipsec sad sad-entries 4 config remote-peer ipv4-address 10.10.0.3
set network-instances network-instance vrf1 security ipsec sad sad-entries 4 config esp authentication hmac-sha1-96 key-str 10112233445566778899aabbccddeeff00112233
set network-instances network-instance vrf1 security ipsec sad sad-entries 4 config esp encryption aes-128-cbc key-str 10112233445566778899aabbccddeeff
set network-instances network-instance vrf1 security ipsec sad sad-entries 5 config sa-mode tunnel
set network-instances network-instance vrf1 security ipsec sad sad-entries 5 config life-time life-time-in-seconds 0
set network-instances network-instance vrf1 security ipsec sad sad-entries 5 config life-time life-time-in-byte 0
set network-instances network-instance vrf1 security ipsec sad sad-entries 5 config local-peer ipv4-address 10.10.0.3
set network-instances network-instance vrf1 security ipsec sad sad-entries 5 config remote-peer ipv4-address 10.10.0.1
set network-instances network-instance vrf1 security ipsec sad sad-entries 5 config esp authentication hmac-sha1-96 key-str 10112233445566778899aabbccddeeff00112232
set network-instances network-instance vrf1 security ipsec sad sad-entries 5 config esp encryption aes-128-cbc key-str 10112233445566778899aabbccddeefe
...
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config spi 4
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config destination-address ipv4-address 172.16.130.0
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config destination-address prefix-length 24
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config destination-address port-number 0
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config upper-protocol any
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config direction outbound
...
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config priority 1
set network-instances network-instance vrf1 security ipsec spd spd-entries sp1 config policy protect
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config spi 5
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config source-address ipv4-address 172.16.130.0
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config source-address prefix-length 24
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config source-address port-number 0
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config upper-protocol any
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config direction inbound
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config security-protocol esp
set network-instances network-instance vrf1 security ipsec spd spd-entries sp2 config priority 1
