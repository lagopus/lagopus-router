...
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 192.168.0.1 config prefix-length 24
...
set interfaces interface tif0 subinterfaces subinterface 0 tunnel config local-inet-address 192.168.0.1
...
set network-instances network-instance vrf1 security ipsec sad sad-entries 2 config local-peer ipv4-address 192.168.0.1
...
set network-instances network-instance vrf1 security ipsec sad sad-entries 2 config encap-protocol udp
set network-instances network-instance vrf1 security ipsec sad sad-entries 2 config encap-dst-port 4500
set network-instances network-instance vrf1 security ipsec sad sad-entries 2 config encap-src-port 4500
...
set network-instances network-instance vrf1 security ipsec sad sad-entries 3 config remote-peer ipv4-address 192.168.0.1
...
set network-instances network-instance vrf1 security ipsec sad sad-entries 3 config encap-protocol udp
set network-instances network-instance vrf1 security ipsec sad sad-entries 3 config encap-dst-port 4500
set network-instances network-instance vrf1 security ipsec sad sad-entries 3 config encap-src-port 4500
