...
set interfaces interface if2 subinterfaces subinterface 0 ipv4 addresses address 172.16.210.1 config ip 172.16.210.1
set interfaces interface if2 subinterfaces subinterface 0 ipv4 addresses address 172.16.210.1 config prefix-length 24
...
set interfaces interface if3 subinterfaces subinterface 0 ipv4 addresses address 10.20.0.1 config ip 10.20.0.1
set interfaces interface if3 subinterfaces subinterface 0 ipv4 addresses address 10.20.0.1 config prefix-length 24
...
set network-instances network-instance vrf2 interfaces interface if3-0 config interface if3
