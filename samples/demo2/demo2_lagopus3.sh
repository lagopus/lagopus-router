...
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.1 config ip 172.16.30.1
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.1 config prefix-length 24
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.1 vrrp vrrp-group 1 config virtual-router-id 1
...
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.1 config ip 172.16.40.1
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.1 config prefix-length 24
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.1 vrrp vrrp-group 1 config virtual-router-id 1
