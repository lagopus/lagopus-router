...
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.2 vrrp vrrp-group 1 config preempt-delay 100
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.2 vrrp vrrp-group 1 config accept-mode true
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.2 vrrp vrrp-group 1 config advertisement-interval 1000
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.2 vrrp vrrp-group 1 interface-tracking config track-interface if0
set interfaces interface if0 subinterfaces subinterface 0 ipv4 addresses address 172.16.30.2 vrrp vrrp-group 1 interface-tracking config priority-decrement 60
...
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.2 vrrp vrrp-group 1 config preempt-delay 100
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.2 vrrp vrrp-group 1 config accept-mode true
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.2 vrrp vrrp-group 1 config advertisement-interval 1000
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.2 vrrp vrrp-group 1 interface-tracking config track-interface if1
set interfaces interface if1 subinterfaces subinterface 0 ipv4 addresses address 172.16.40.2 vrrp vrrp-group 1 interface-tracking config priority-decrement 60
