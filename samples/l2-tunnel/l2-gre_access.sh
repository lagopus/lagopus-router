...
set interfaces interface if1 subinterfaces subinterface 100 vlan config vlan-id 100
set interfaces interface if1 subinterfaces subinterface 100 config enabled true
...
set network-instances network-instance vsi1 interfaces interface if1 subinterface 100
