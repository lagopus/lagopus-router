...
set interfaces interface if0 subinterfaces subinterface 300 vlan config vlan-id 300
set interfaces interface if0 subinterfaces subinterface 300 config enabled true
...
set interfaces interface tif1 ethernet switched-vlan config access-vlan 200
...
set interfaces interface tif2 tunnel config remote-inet-address 10.10.0.2
...
set interfaces interface tif2 subinterfaces subinterface 300 vlan config vlan-id 300
set interfaces interface tif2 subinterfaces subinterface 300 config enabled true
...
set network-instances network-instance vsi1 interfaces interface if0 subinterface 300
...
set network-instances network-instance vsi1 interfaces interface tif2 subinterface 300
